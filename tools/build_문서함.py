...
# ─────────────────────────────────────────────────────────────
DOCS = [
    ("docs/논문초고/_논문_전체.md",                    "논문 초고", "★ 논문 전체 (합본)",      "초고", "draft"),
    ("docs/논문초고/제1장_서론.md",                    "논문 초고", "제1장 서론",              "초고", "draft"),
    ("docs/논문초고/제2장_이론적배경및가설설정.md",    "논문 초고", "제2장 이론적 배경·가설",  "초고", "draft"),
    ("docs/논문초고/제3장_연구모형및연구방법.md",      "논문 초고", "제3장 연구모형·연구방법", "초고", "draft"),
    ("docs/논문초고/제4장_제5장_틀.md",                "논문 초고", "제4·5장 틀",              "자료 대기", "wait"),
    ...
    ("docs/11_SPSS_분석절차.md",                "지금 — 설문 배포 전", "SPSS 분석 절차",       "확정",      "ok"),

    ("docs/10_외부지시서_검토.md",              "확정 · 근거",         "외부 지시서 검토",     "검토 완료", "ok"),
    ("references/외부지시서_문헌검증.md",       "확정 · 근거",         "외부지시서 문헌검증",  "검증 완료", "ok"),
    ("references/직무경력_조절효과_문헌매트릭스.md", "확정 · 근거",    "직무경력 문헌 매트릭스", "검증 완료", "ok"),
